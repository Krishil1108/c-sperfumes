                  ...
                  <div className="product-details">
                    ...
                    <div className="product-footer">
                      ...
                      {product.inStock ? (
                        ...
                        <button className="btn-add-cart" style={{ background: 'rgba(0,0,0,0.06)', border: '1px solid rgba(0,0,0,0.05)', cursor: 'not-allowed', color: 'var(--text-muted)', width: '42px', height: '42px', display: 'flex', alignItems: 'center', justifyContent: 'center' }} disabled>
